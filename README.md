...
[![pub package](https://img.shields.io/pub/v/bezier_chart_plus.svg)](https://pub.dev/packages/bezier_chart_plus)

A beautiful bezier line chart widget for flutter that is highly interactive and configurable. This is an updated version of `bezier_chart` to support dart3 and latest flutter versions. Original version remains [here](https://raw.githubusercontent.com/aeyrium/bezier-chart)
...
<p>
<img src="https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExMGZhNWFkYTBkOWMzOWM5ODA5NjEyOTQ3YTYyMGUxMzVmNzQyZDMyZSZlcD12MV9pbnRlcm5hbF9naWZzX2dpZklkJmN0PWc/Z0snAJQxD6QNTp6Vdi/giphy.gif" alt="drawing" width="230px" hspace="5"/> 
...
Main credit goes to [@diegoveloper](https://www.twitter.com/diegoveloper)