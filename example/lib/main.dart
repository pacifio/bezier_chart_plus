...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Bezier Chart Plus Sample"),
      ),
        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              subtitle: const Text("Number Chart"),
              onTap: () => _onTap(
                context,
                sample1(context),
              ),
            ...
            ListTile(
              ...
              subtitle: const Text("Number Chart/ multi curves"),
              onTap: () => _onTap(
                context,
                sample2(context),
              ),
            ...
            ListTile(
              ...
              subtitle: const Text("Weekly Chart"),
              onTap: () => _onTap(
                context,
                sample3(context),
              ),
            ...
            ListTile(
              ...
              subtitle: const Text("Montly Chart"),
              onTap: () => _onTap(
                context,
                sample4(context),
              ),
            ...
            ListTile(
              title: const Text("Sample 5"),
              subtitle: const Text("Yearly Chart"),
              onTap: () => _onTap(
                context,
                sample5(context),
              ),
            ...
            ListTile(
              title: const Text("Sample 6"),
              subtitle: const Text("Main Chart"),
              onTap: () => _onTap(
                context,
                sample6(context),
              ),
            ...
            ListTile(
              title: const Text("Sample 7"),
              subtitle: const Text("Custom Chart - Number"),
              onTap: () => _onTap(
                context,
                sample7(context),
              ),
            ...
            ListTile(
              title: const Text("Sample 8"),
              subtitle: const Text("Hourly Chart"),
              onTap: () => _onTap(
                context,
                sample8(context),
              ),
            ...
            ListTile(
              title: const Text("Sample 9"),
              subtitle: const Text("BezierChartScale.WEEKLY same day"),
              onTap: () => _onTap(
                context,
                sample9(context),
              ),
            ...
            ListTile(
              title: const Text("Sample 10"),
              subtitle: const Text("Async Custom Chart - Number"),
              onTap: () => _onTap(
                context,
                const Sample10(),
              ),
            ...
            ListTile(
              title: const Text("Sample 11"),
              subtitle: const Text("Custom Bubble Label Example"),
              onTap: () => _onTap(
                context,
                sample11(context),
              ),
            ...
            ListTile(
              title: const Text("Sample 12"),
              subtitle: const Text("Dynamic date range"),
              onTap: () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => const Sample12())),
            ),
            ListTile(
              title: const Text("Sample 13"),
              subtitle: const Text("Dynamic date range"),
              onTap: () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => const Sample13())),
            ),
            ListTile(
              title: const Text("Sample 14"),
              subtitle: const Text(
                  "Sample with updatePositionOnTap & format indicator value"),
              onTap: () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => const Sample14())),
            ),
          ],
        ),
      ),
...
Widget sample5(BuildContext context) {
  ...
  final date3 = DateTime.now().subtract(const Duration(days: 300));
  final date4 = DateTime.now().subtract(const Duration(days: 320));

  final date5 = DateTime.now().subtract(const Duration(days: 650));
  final date6 = DateTime.now().subtract(const Duration(days: 2000));

  final date7 = DateTime.now().subtract(const Duration(days: 2500));
...
_buildChart(
  ...
  final date5 = DateTime.now().subtract(const Duration(days: 650));
  final date6 = DateTime.now().subtract(const Duration(days: 652));
...
Widget sample8(BuildContext context) {
  final fromDate = DateTime.now().subtract(const Duration(hours: 50));
  final toDate = DateTime.now();

  final date1 = toDate.subtract(const Duration(hours: 2));
  final date2 = toDate.subtract(const Duration(hours: 3));

  final date3 = toDate.subtract(const Duration(hours: 10));
  final date4 = toDate.subtract(const Duration(hours: 15));

  final date5 = toDate.subtract(const Duration(hours: 19));
  final date6 = toDate.subtract(const Duration(hours: 26));
    ...
    child: Container(
      ...
      child: BezierChart(
        ...
        config: BezierChartConfig(
          ...
          showVerticalIndicator: true,
          verticalIndicatorFixedPosition: false,
          bubbleIndicatorTitleStyle: const TextStyle(
            color: Colors.blue,
          ),
          bubbleIndicatorLabelStyle: const TextStyle(
            color: Colors.red,
          ),
          displayYAxis: true,
          stepsYAxis: 25,
